...
<br /><br />
    <table border="1">
    <tr>
    <td style="width: 266px;">Product Name</td>
    <td style="width: 134px;">Unit Price (GHs)</td>
    <td style="width: 133px;">Category</td>
    </tr>
    </table>
    <style>
    table{
...
foreach($products as $k => $v){
    ...
    <td style="width: 134px;">'.$v['selling_price'].'</td>
    <td style="width: 133px;">'.$v['cat_name'].'</td>
    </tr>
    ';
}
