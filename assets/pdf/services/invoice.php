...
if($duration_count > 0){ 
    ...
    <td style="width: 190px; border-right: solid 1px black; border-top: solid 1px black;">Description
    </td>
    <td style="width: 110px; border-right: solid 1px black; border-top: solid 1px black;">Duration  '.$duration.'
    </td>
