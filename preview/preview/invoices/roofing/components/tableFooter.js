  ...
  <table cellpadding="0" style="background-color: #514b4d; color: white;">  
    <tbody>
      ...
      <tr>  
        ...
        <td style="border-right: solid 0.1rem white; width: 10rem; padding: 1.6rem;">
          YOUR
          <br />
      ...
      <tr>
        <td  style="background-color: #4d4c52; height: 0.2rem; width: 10rem;"></td>
        <td  style="background-color: #fbb313; height: 0.2rem;  width: 13rem;"></td>
        <td  style="background-color: #fbb313; height: 0.2rem;  width: 15rem;"></td>
        <td  style="background-color: #fbb313; height: 0.2rem;  width: 15rem;"></td>
      </tr>
